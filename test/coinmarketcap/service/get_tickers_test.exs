defmodule Coinmarketcap.Service.GetTickersTest do
  ...
  test "sends request to /ticker/ and returns Coinmarketcap.Ticker structs" do
    InMemoryClient.push(%Response{status: :ok, body: [%{
      ...
      "rank" => "20",
      "price_usd" => "1.99753",
      "price_btc" => "0.00017384",
      "24h_volume_usd" => "3762760.0",
      "market_cap_usd" => "1995531461.0",
    ...
    assert {:ok, [%Ticker{
      ...
      rank: 20,
      usd_price: 1.99753,
      btc_price: 0.00017384,
      volume: 3762760.0,
      market_cap: 1995531461.0,
      available_supply: 998999495.0,
      total_supply: 998999495.0,
      max_supply: 998999495.0,
      percentage_change: %{
      ...
      updated_at: ~N[2018-01-16 10:04:09],
    }, %Ticker{
      id: "ethereum",
      name: "Ethereum",
      symbol: "ETH",
